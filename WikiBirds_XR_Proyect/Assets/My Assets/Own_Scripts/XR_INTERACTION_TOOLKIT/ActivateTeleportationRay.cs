/*
 * Script que activa TeleportationRays solo cuando se pulsan las teclas de teletransporte
 * 
...
public class ActivateTeleportationRay : MonoBehaviour
{
    ...
    public InputActionProperty leftActivate;    //For trigger button values
    public InputActionProperty rightActivate;

    public InputActionProperty leftCancel;      //For grip button values
